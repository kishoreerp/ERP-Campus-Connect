...
final List<String> _generalAudiences = [
  'All Years',
  '1st Year',
  '2nd Year',
  '3rd Year',
...
final List<String> _subjectAudiences = [
...
List<String> get _currentAudienceList =>
...
_fieldLabel('Announcement Category'),
const SizedBox(height: 6),
_buildDropdown(
  ...
  onChanged: (v) {
    setState(() {
      _selectedCategory = v!;
      _selectedAudience = _currentAudienceList.first;
    });
  },
),
