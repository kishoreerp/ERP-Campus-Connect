...
class InternalAssessment1Screen extends StatelessWidget {
  const InternalAssessment1Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Internal Assessment 1',
                    ...
                    children: [
                      Expanded(
                        child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Internal Assessment 1 - $subject',
                                  style: GoogleFonts.inter(
